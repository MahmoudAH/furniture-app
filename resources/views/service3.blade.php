    ...
    <div class="container" style="padding-bottom: 30px;border-bottom: 2px solid #d9d9f3">
      <div class="row">
        <div class="col-md-6 " style="margin-top: 100px">
          ...
          <p>
          يوجد لدينا نحن شركه الخليج العربي لنقل الأثاث عمال نجاره متخصصين في عمليه الفك والتركيب الأثاث وذلك يتم بكل حرص وبكل مهاره ويتم التعامل مع الأثاث على حده.
      ...
      <div class="col-md-4 col-md-offset-1" style="margin-top: 70px">
        <div>
        <img class="img-responsive" src="/images/فك.jpg"/>
