...
<div class="wrapper" id="app">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b> لوحه التحكم </b> </span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          <a href="">
            <i class="fa fa-dashboard"></i> <span>الاعضاء</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="{{ route('users.index') }}"><i class="fa fa-circle-o"></i> الاعضاء </a></li>
            <li class="active"><a href="{{ route('roles.index') }}"><i class="fa fa-circle-o"></i> الادوار</a></li>
            <li><a href="{{ route('permissions.index') }}"><i class="fa fa-circle-o"></i>  الصلاحيات</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
